...
#         [Paragraph("Other_Allowance(Variable Pay)",small_font_style),get_attr('other_allowance','#N/A'), "Tax", get_attr('tax','0')],
...
def generate_exact_payslip_pdf(employee):
    ...
    footer_style = ParagraphStyle(
     ...
     # Custom style for reduced font size
    small_font_style = ParagraphStyle(
        'SmallFont',
        parent=styles['Normal'],
    ...
    earnings_deductions_data = [
        ...
        ["HRA", get_attr('hra', '#N/A'), "ESI", get_attr('esi', '#N/A')],
        ["LTA", get_attr('lta', '#N/A'), "Professional Tax", get_attr('professional_tax', '#N/A')],
        # ["Other Allowance(Variable Pay)", get_attr('other_allowance', '#N/A'), "Tax", get_attr('tax', '0')],
        [Paragraph("Other Allowance (Variable Pay)", small_font_style), get_attr('other_allowance', '#N/A'), "Tax", get_attr('tax', '0')],
        ["Total Addition", get_attr('total_addition', '#N/A'), "Total Deductions", get_attr('total_deductions', '0')],
    ]
    ...
    additional_data = [
        ["No of days worked this month",get_attr('days_worked', "#N/A")],
        ["Net Salary", get_attr('net_salary', '#N/A')],
        ["Salary in words", Paragraph(get_attr('salary_in_words','#N/A'), small_font_style)],
    ]
